...
typedef struct {
    ...
    unsigned int match_subnet_ipv6;     /* size of subnets to match/aggregate, CIDR notation */
    unsigned int match_subnet_ipv4;     /* size of subnets to match/aggregate, CIDR notation */
